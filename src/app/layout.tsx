...
export const metadata: Metadata = {
  ...
  description: "Professional 2D animation, illustration, motion graphics and VFX. Let your ideas come to life with unique visual storytelling.",
  keywords: ["Illustration", "Animation", "2D", "VFX", "Motion Graphics", "Artist Portfolio", "Christopher"],
